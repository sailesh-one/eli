<?php 
    ...
    {
        case 'list':
            $result = $users->getmodules($role_type);
            $permissions = $users->getrolepermissions();
            $roles = $users->getroles($role_type);
            $data = array_merge(
                $result ?: [],
                $permissions ?: [],
                $roles ?: []
        ...
        case 'removerolepermission':
            ...
            if ($result) {
                api_response(200, 'ok', 'Permission removed successfully', [$result]);
            } else {
        ...
        case 'addrolepermission':
            ...
            if ($result) {
                api_response(200, 'ok', 'Permission added successfully', [$result]);
            } else {
